...
function buildProxy () {
  ...
  proxy._write = function (chunk, encoding, next) {
    // uni-app socket send ArrayBuffer, we need convert Buffer to ArrayBuffer
    // see https://uniapp.dcloud.net.cn/api/request/socket-task.html#sockettask-send
    // see https://uniapp.dcloud.net.cn/api/request/websocket.html
...
function buildUrl (opts, client) {
  const protocol = opts.protocol === 'unis' ? 'wss' : 'ws'
